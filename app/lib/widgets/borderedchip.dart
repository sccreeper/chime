...
class BorderedChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(text, textAlign: TextAlign.center, style: GoogleFonts.ibmPlexSans(color: const Color(0xFFF9A825), fontSize: 14, fontWeight: FontWeight.w200),),
    );
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Row(children: [
          ...
          Text(text, textAlign: TextAlign.center, style: GoogleFonts.ibmPlexSans(color: const Color(0xFFF9A825), fontSize: 14, fontWeight: FontWeight.w200),)
        ]),
      ),
