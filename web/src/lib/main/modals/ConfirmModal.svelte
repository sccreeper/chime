<script>
    ...
    export let message = ""
    export let callback = function (confirmed) {}
  ...
  <div role="dialog" class="modal">
    <div class="contents">
        ...
        <div class="w-48 flex flex-row items-center gap-3">

            <button on:click={() => {callback(true)}}>Yes</button>
            <button on:click={() => {callback(false)}}>No</button>
